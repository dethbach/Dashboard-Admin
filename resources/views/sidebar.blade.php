...
<head>
    ...
    <title>Sidebar</title>
    <link rel="icon" type="image/png" href="{{asset('storage/web-material/icon.png')}}">
...
<body>
    @php $sidetitle = "Dashboard" @endphp
    <!-- NAVBAR -->
            ...
            <div class="row g-2">
                <div class="mb-md-0 mb-sm-2 col-md-2 col-sm-12">
                    <div class="d-flex justify-content-between">
                        <a href="/dashboard" class="align-items-center text-decoration-none">
                ...
                <!-- <div class="mb-md-0 mb-sm-2 col-md-5 col-sm-12">
                    <form action="/detail-customer" method="POST" style="width:100%;">
                        @csrf
                                ...
                                <a href="#" class="d-block link-dark text-decoration-none fw-semibold" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="row g-2">
                                        ...
                                        <div class="col text-start">
                                            <h5 class="my-0 fw-bold"><small>Kelvin</small></h5>
                                            <p class="my-0 text-muted" style="font-size: smaller;">Admin</p>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <div class="offcanvas-body px-0 py-0">
                        ...
                        <div class="flex-shrink-0 p-3 navbar-expand-md vh-100 sticky-top">
                            <ul class="list-unstyled ps-0">
                                ...
                                <li class="mb-1">
                                    <a type="button" href="/dashboard" class="btn @if($sidetitle == 'Dashboard') active-sidebar @endif btn-non-toggle d-inline-flex align-items-center rounded border-0 fw-bold">
                                ...
                                <li class="mb-1">
                                    ...
                                    <div class="collapse" id="dashboard-collapse">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                            <li><a href="/categories" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-tags-fill me-2"></i> Categories</a></li>
                                            <li><a href="/write-post" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-feather me-2"></i> Add New</a></li>
                                            <li><a href="/posts" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-file-earmark-post me-2"></i> All Posts</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="mb-1">
                                    ...
                                    <div class="collapse" id="dashboard-settings">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                            <li><a href="/cities" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-globe-americas me-2"></i> Cities</a></li>
                                            <li><a href="/profile" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-person-lines-fill me-2"></i> My Profile</a></li>
                                            <li><a href="/account" class="btn-non-toggle d-inline-flex text-decoration-none fw-semibold align-items-center rounded ps-4 mt-1"><i class="bi bi-person-vcard-fill me-2"></i> Account</a></li>
                                        </ul>
                                    </div>
                                </li>
    ...
    <!-- <div class="modal fade" id="modalSearch" tabindex="-1" aria-labelledby="modalSearchLabel" data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <form action="/service/search" method="POST" enctype="multipart/form-data">
                @csrf
